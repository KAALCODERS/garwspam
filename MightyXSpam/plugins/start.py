...
MIG_IMG = ALIVE_PIC if ALIVE_PIC else "https://telegra.ph/file/20dda006e65de620ee475.jpg"
...
MigX_Button = [
        ...
        [
        Button.url("• ʀᴇᴘᴏ •", "https://github.com/garwmishra/garwspam")
        ]
        ]
